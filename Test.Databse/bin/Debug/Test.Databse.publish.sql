...
GO
PRINT N'Creating [dbo].[CustomerVarientCost]...';
...
GO
PRINT N'Creating [dbo].[DistanceVarientBaseCost]...';


GO
CREATE TABLE [dbo].[DistanceVarientBaseCost] (
    [Id]          INT        NOT NULL,
    [MinDist]     INT        NULL,
    [MaxDist]     NCHAR (10) NULL,
    [OverAllCost] FLOAT (53) NULL,
    PRIMARY KEY CLUSTERED ([Id] ASC)
);
...
GO
PRINT N'Creating [dbo].[StairsVarientBaseCost]...';


GO
CREATE TABLE [dbo].[StairsVarientBaseCost] (
    [Id]          INT        NOT NULL,
    [MinStair]    INT        NULL,
    [MaxStair]    INT        NULL,
    [OverAllCost] FLOAT (53) NULL,
